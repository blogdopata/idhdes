      ...
      <div class="col-md-10 col-md-offset-1">
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="tabla-diplomado">
                          <tr  >
                            ...
                            <td>Jueves 26 de noviembre de 2016</td>
                          </tr>
                          <tr>
                            <td class="info-event" >Hora:</td>
                            <td>18:15 – 21:00 horas</td>
                          </tr>
                          <tr>
                            <td class="info-event" >Lugar:</td>
                            <td>Set de Televisión No. 1 – Facultad de Ciencias de Comunicación, Turismo y Psicología.  <br>Sito Av. Tomás Marsano No. 242 - Surquillo</td>
                          </tr>
                    ...
                    <h5 class="titleH5">Información</h5>
                      ...
                      <p class="txt-General" >El Instituto de Derechos Humanos y Desarrollo (“IDHDES”) de la Universidad de San Martín de Porres, creado con la finalidad de propiciar espacios abiertos de reflexión y dialogo a partir de la publicación de trabajos de investigación, entrevistas especializadas, difusión de cursos presenciales y virtuales, así como la realización de eventos académicos que permitan la capacitación académica y participación activa de la sociedad civil, llevará a cabo, en el marco de su Segundo Aniversario el evento “LIBERTAD DE EXPRESIÓN Y COMUNICACIÓN POLÍTICA EN LAS REDES SOCIALES”.
                      </p>

                      <p class="txt-General" >

                      El referido evento contará con la participación en calidad de expositores a periodistas reconocidos/as, comunicadores, blogers, y especialistas en libertad de expresión, comunicación política y digital con reconocida trayectoria.
                      </p>
                      <p class="txt-General" >

                      Asimismo, en dicho escenario se hará la presentación de los cuadernos de investigación del IDHDES sobre libertad de expresión escrito por nuestros profesores investigadores.
                      </p>

                      <p class="txt-General" >

                      Objetivo: El objetivo del evento es crear un espacio de reflexión y debate acerca de cómo se ejerce la libertad de expresión en el debate político que se desarrolla en las redes sociales, así como la percepción de la opinión pública, la participación comunicacional de los partidos políticos y la influencia de la prensa en el diseño y desarrollo de la agenda política electoral, la construcción del perfil del candidato entre otros temas importantes que inciden en la campaña electoral
                      </p>
                      ...
                      <h5 class="titleH5">Certificación</h5>
                       <p class="txt-General" >
                        ...
                        A los participantes asistentes al evento de nuestro II Aniversario Institucional 
                      ...
                      <h5 class="titleH5">Expositores</h5>
                         <ul class="list-expo">
                            ...
                            <li><span class="ion-person"></span> Betsabe Marciani Burgos - Docente USMP y Especialista en libertad de expresión.</li>

                            <li><span class="ion-person"></span> Eugenio D’ Medina Lora - Licenciado en Economía y BSc en Ciencias Sociales de la Pontificia Universidad Católica del Perú, MBA de la Universidad de Québec en Montreal. </li>

                            <li><span class="ion-person"></span> Graciela Rubina Carpio -Directora de Interactive Advertising Bureau –IAB</li>

                            <li><span class="ion-person"></span> Mario Saldaña Castro - Periodista</li>

                            <li><span class="ion-person"></span> José Manuel Saavedra Molina - Consultor y estratega político</li>

                            <li><span class="ion-person"></span> Valia Barak Pastor - Periodista</li>
                        ...
                        <h5 class="titleH5">Programa</h5>
                        
                        <a href="pdf/eventos/Libertad-de-expresion.pdf" target="_blank">
                            Decargar porgrama <span class="ion-arrow-right-c"></span>
        ...
        <!-- ------------------------ IN HOUSE --------------------------- -->
                <div id="menu3" class="tab-pane fade">
                  ...
                  <h5 class="titleH5-sub">CURSOS IN HOUSE</h5> 
