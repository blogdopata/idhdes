      ...
      <div class="container">
        <div class="row" style="margin-bottom: 40px;"> 
          <div class="col-md-12 text-center"> 
           <h2 class="title-contenido"> #LunesDeIgualdad</h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container"  >
        <div class="row "> 
          ...
          <div class="shareTwitter">
                    <a href="https://twitter.com/share" class="twitter-share-button" data-lang="es" data-text="POR UNA EDUCACIÓN EFICIENTE E IGUALITARIA - #LunesDeIgualdad" data-url="http://usmp.edu.pe/IDHDES/contenido/htnota/lunesIgualdad.php"  data-via="IDHDES USMP"></a>
              ...
              <p  class="txt-General">
                      ...
                      <span><i><a href="http://peru21.pe/actualidad/crecen-brechas-inequidad-educativa-peru-2243974" target="_blank">http://peru21.pe/actualidad/crecen-brechas-inequidad-educativa-peru-2243974</a></i></span>
              </p>
               <br>
          </div>
        </div>
